...
def downloadMapBox(zoom, p, outputname):
	token = os.getenv("MAPBOX_ACCESS_TOKEN", "pk.placeholder_token")
	url = "https://c.tiles.mapbox.com/v4/mapbox.satellite/%d/%d/%d@2x.jpg?access_token=%s" % (zoom, p[0], p[1], token)
	filename = "%d@2x.jpg?access_token=%s" % (p[1], token)
...
# https://c.tiles.mapbox.com/v4/mapbox.satellite/15/5264/11434@2x.jpg?access_token=REPLACE_WITH_TOKEN
